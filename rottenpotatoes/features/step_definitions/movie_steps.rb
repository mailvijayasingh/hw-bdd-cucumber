...
When /I uncheck the following ratings: (.*)/ do |uncheck, rating_list|
...
page.all('table#movies tbody tr').count.should == 0 #Movie.count()
 
end


When /I check the following ratings: (.*)/ do |uncheck, rating_list|
